...
if uploaded_file:
    try:
        ...
        if st.button("🚀 Processar"):
            ...
            # ORDEM FINAL PEDIDA (AJUSTADO: Endereço Original no final)
            ordem_final_colunas = [
                "ID_Personalizado",
                "Nome_Final",
                "CEP_Final",
                ...
                "Regiao_Final",
                "Aos_Cuidados_Final",
                c_end # Endereço Original movido para o final
            ]
            ...
            with pd.ExcelWriter(buffer2, engine='xlsxwriter') as writer:
                ...
                # Nomes das colunas reordenados para bater com a ordem dos dados
                df_final.columns = [
